...
\only<5>{
    \begin{tikzpicture}
        ...
        \draw[line width=1pt, ->] (11.5,-1) -- (11.5,0);
        \draw[line width=1pt, ->] (11.5,3.5) -- (11.5,4);
...
\only<6>{
    \begin{tikzpicture}
        ...
        \filldraw[draw=black, fill=gray!10] (0.25,0.25) rectangle (2.75,0.75) node() [pos=.5] {File 3};
        \filldraw[draw=black, fill=gray!10] (10.25,1.25) rectangle (12.75,1.75) node() [pos=.5] {File 2};
        \filldraw[draw=black, fill=gray!10] (10.25,0.25) rectangle (12.75,0.75) node() [pos=.5] {File 1};
        \node() at(13,4){};
        \node() at(13,-1){};
    \end{tikzpicture}
}
